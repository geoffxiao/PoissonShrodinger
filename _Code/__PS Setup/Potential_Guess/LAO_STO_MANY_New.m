...
FILE_NAME = 'LAO_STO_MANY_New'; % Save to
...
x = [0 : h : 161.14e-9]'; % Global variable for the x axis
interfaces = [381; 781];
for i = 3 : 29
   if(mod(i,2) == 0) 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Potential Guess %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
i = 0    
guess_init = guess_init + [([1 : interfaces(i + 1)]' - interfaces(i + 1)) * (-4) / 400;...
