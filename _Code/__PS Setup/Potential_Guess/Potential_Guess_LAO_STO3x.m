...
FILE_NAME = 'LAO_STO_MANY'; % Save to
...
x = [0 : h : 29.12e-9]'; % Global variable for the x axis
interfaces = [153; 554; 705; 1106; 1257; 1658; ...
              1809; 2210; 2361; 2762]; % index of the interfaces in the material
...
Eg_params = [Eg1, Eg2, Eg1, Eg2, Eg1, Eg2,...
             Eg1, Eg2, Eg1, Eg2, Eg1 ];

% Left material is above right material by this much
dEc12 = 2.5; % 1 is above 2 by this much
dEc_params = [dEc12 -dEc12 dEc12 -dEc12 dEc12 -dEc12 ...
              dEc12 -dEc12 dEc12 -dEc12 ];

epsilon_r1 = 27; % LAO
epsilon_r2 = 300; % STO
epsilon_r_params = [epsilon_r1, epsilon_r2, epsilon_r1, epsilon_r2, epsilon_r1, epsilon_r2, ...
                    epsilon_r1, epsilon_r2, epsilon_r1, epsilon_r2, epsilon_r1 ];

% Electron and hole effective masses
M_es = [0.4; 0.4; 0.4; 0.4; 0.4; 0.4; 0.4; 0.4; 0.4; 0.4; 0.4] * M;
M_hs = [1.2; 1.2; 1.2; 1.2; 1.2; 1.2; 1.2; 1.2; 1.2; 1.2; 1.2] * M; 
...
LAO_f = flipud(LAO);
STO = zeros(399, 1);
Other_Charges = [LAO; STO; LAO; STO; LAO; STO; LAO_f; STO; ...
                 LAO_f; STO; LAO_f];
